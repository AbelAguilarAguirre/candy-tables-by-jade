            ...
            <main className="flex min-h-screen w-full max-w-3xl flex-col items-center py-8 dark:bg-black ">
                ...
                <div className="flex flex-row gap-1 flex-wrap justify-evenly">
                    <div className="w-[48vw] border-2">
                        <h2 className="bg-background dark:bg-white">♡Mini♡</h2>
                        <p className="text-base mt-[-15px] bg-background dark:bg-white w-full text-center pb-[5px] ">
                            5 Dozen - 60 items
                        </p>
                        ...
                        <h2 className="py-0 bg-white">$155</h2>
                        <p className="text-center bg-white">
                            2-3 colors <br />
                            sprinkles or shimmer
                        </p>
                        <p className="text-center py-2 bg-white">
                            Add gold or silver <br />
                            +$10
                        </p>
                    </div>
                    <div className="w-[48vw] border-2">
                        <h2 className="bg-background dark:bg-white">♡Small♡</h2>
                        <p className="text-base mt-[-15px] bg-background dark:bg-white w-full text-center pb-[5px] ">
                            8 Dozen - 96 items
                        </p>
                        <p className="bg-foreground px-4 py-1">
                        ...
                        <h2 className="py-0 bg-white">$250</h2>
                        <p className="text-center bg-white">
                            2-3 colors <br />
                            sprinkles or shimmer
                        </p>
                    ...
                    <div className="w-[48vw] border-2">
                        <h2 className="bg-background dark:bg-white">
                            ♡Classic♡
                        </h2>
                        <p className="text-base mt-[-15px] bg-background dark:bg-white w-full text-center pb-[5px] ">
                            12 Dozen - 144 items
                        ...
                        <h2 className="py-0 bg-white">$310</h2>
                        <p className="text-center bg-white">
                            2-3 colors <br />
                            sprinkles or shimmer
                        </p>
                    ...
                    <div className="w-[48vw] border-2">
                        ...
                        <h2 className="py-0 bg-white">$500</h2>
                        <p className="text-center bg-white">
                            2-4 colors <br />
                            sprinkles or shimmer
                        </p>
                ...
                <h2 className="dark:text-foreground">
                    <hr />
                    ♡Dessert Menu♡
                    <hr />
                </h2>
                ...
                <div className="flex flex-col gap-1 flex-wrap justify-evenly">
                    ...
                    <p className="text-center text-sm dark:text-foreground">
                    ...
                    <p className="text-center text-4xl dark:text-foreground">
                        ♡
                    </p>
                    <p className="text-center dark:text-foreground">
                        Add-ons and themed desserts may include an additional
